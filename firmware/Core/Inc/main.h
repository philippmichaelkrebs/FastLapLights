...
#define TRACK_LIGHTS_R_Pin GPIO_PIN_2
#define TRACK_LIGHTS_R_GPIO_Port GPIOA
#define TRACK_LIGHTS_G_Pin GPIO_PIN_3
#define TRACK_LIGHTS_G_GPIO_Port GPIOA
#define IO_DATA_INT_Pin GPIO_PIN_4
#define IO_DATA_INT_GPIO_Port GPIOA
#define IO_POWER_RAIL_DATA_Pin GPIO_PIN_6
#define IO_POWER_RAIL_DATA_GPIO_Port GPIOA
